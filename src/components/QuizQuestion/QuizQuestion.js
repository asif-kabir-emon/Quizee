...
const QuizQuestion = ({ quizQuestion }) => {
  ...
  return (
    <div className="flex justify-center my-5">
      <div className="bg-slate-200 p-6 rounded-md quiz-question-option">
        <div className="flex justify-between items-center">
          <div className="text-2xl my-3">{parse(question)}</div>
          <div>
        ...
        <div className="text-left">
          {options.map((option) => (
            <div className="border-2 text-lg bg-slate-400 px-2 py-1 my-1 rounded">
              <input
                type="radio"
                name={id}
                value={option}
